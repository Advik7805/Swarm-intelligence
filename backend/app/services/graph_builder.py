...
class GraphBuilderService:
    ...
    def create_graph(
        ...
        *,
        ...
        graph_id = graph_id or f"hivemind_{uuid.uuid4().hex[:16]}"
        ...
        try:
            self.client.graph.create(
                graph_id=graph_id,
                name=name,
                description="HiveMind Social Simulation Graph"
            )
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            while True:
                ...
                for batch in getattr(page, "batches", None) or []:
                    ...
                    if (
                        metadata.get("hivemind_operation_id") == operation_id
        ...
        for i in range(0, total_chunks, batch_size):
            ...
            items = [
                BatchAddItem(
                    ...
                    data=chunk,
                    data_type="text",
                    source_description="HiveMind source document chunk",
                    metadata={
                        "hivemind_operation_id": operation_id,
